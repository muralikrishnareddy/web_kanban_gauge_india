...
instance.web_kanban.GaugeWidget = instance.web_kanban.AbstractField.extend({
    ...
    start: function() {
        ...
        var humanFriendlyDecimal=0;
        if (this.options.humanFriendlyDecimal) {
            humanFriendlyDecimal = this.getParent().record[this.options.humanFriendlyDecimal].raw_value;
        }      
        ...
        this.gage = new JustGage({
            ...
            humanFriendly: true,
            humanFriendlyDecimal: humanFriendlyDecimal,
